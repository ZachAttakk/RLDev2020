...
def generate_dungeon(max_rooms: int,
                     ...
                     map_width: int,
                     map_height: int,
                     monsters_per_room: int, max_items_per_room: int,
    ...
    for r in range(max_rooms):
        ...
        # add baddies
        place_entities(new_room, dungeon, monsters_per_room, max_items_per_room)
...
def place_entities(room: RectangularRoom, dungeon: GameMap, max_monsters_per_room: int, max_items: int) -> None:
    # how many monsters?
    ...
    for i in range(number_of_items):
        ...
        if not any(entity.position == prospective_pos for entity in dungeon.entities):
            entity_factories.health_potion.spawn(dungeon, prospective_pos)
